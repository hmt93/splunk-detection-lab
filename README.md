...
**Disclaimer:-** This lab environment is for **educational purposes only**. All attacks were conducted in an isolated, controlled environment with no connection to production systems or networks.
